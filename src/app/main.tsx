...
const Main = () => {
    ...
    const actionOpenButtonSelection = (e: Event) => {
    ...
    const actionOpenMenu = (e: Event, type = "") => {
      e.stopPropagation()
        ...
        <div className='h-100 w-100 px-0 colour-back-extra-dark'>
          <div className="input-group">
            ...
            <div id='mainMenuButtonContainer'>
              <button className={selectedButton == "" ? "btn colour-back-blue rounded-circle" : selectedButton == "inbox" ? "btn colour-back-purple rounded-circle" : "btn colour-back-orange rounded-circle" } id="selectedButton" onClick={actionOpenButtonSelection}>
                {
                  selectedButton == "" ? 
              ...
              <div className="d-flex button-selection" id="buttonSelection">
                {
                  ...
                  <div className={buttonStatus == 0 ? "init" : buttonStatus == 1 ? "show" : "hide"}>
                    ...
                    <button className='btn colour-back-light rounded-circle' id="btnTask" onClick={(e: Event) => {actionOpenMenu(e, "task")}}>
                      <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                }
                {
                  ...
                  <div className={buttonStatus == 0 ? "init" : buttonStatus == 1 ? "show" : "hide"}>
                    ...
                    <button className='btn colour-back-light rounded-circle' id="btnInbox" onClick={(e) => {actionOpenMenu(e, "inbox")}}>
